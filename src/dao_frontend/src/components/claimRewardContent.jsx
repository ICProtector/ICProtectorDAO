  ...
  const checkClaimRewards = async (proposalId) => {
    ...
    try {
      ...
      if (reward === "No Reward yet") {
        alertType = "info"; // Change type to warning for no reward
        ...
        alertType = "info"; // Keep as info or change to another appropriate type
          ...
          {principal ?
            <div className="ml-3 mr-3">
              ...
              {loading ? (
                    ...
                    <tbody className="mt-2">
                      {proposals.map((proposal, index) => (
                        ...
                        >
                          ...
                          <td class="px-6 py-4">
                            <span
                              className={`text-xs font-medium me-2 px-2.5 py-0.5 rounded p-3 bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300`}
                            >
                          ...
                          <td class="px-6 py-4">
                            {proposal.claimed == false ? (
                              <button
                                onClick={() =>
                                  checkClaimRewards(proposal.proposalId)
                                }
                                type="button"
                ...
                <p className="text-black dark:text-white text-lg">No reward to claim.</p>
              )}
            </div>
            :
