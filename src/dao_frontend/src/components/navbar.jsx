  ...
  return (
    <nav className={`relative  px-2 sm:px-4 ${gradientClass} py-1`}>
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className={`${isMobileMenuOpen ? '' : 'hidden'} w-full md:block md:w-auto`} id="navbar-dropdown">
          <ul className={`flex flex-col p-4 mt-4 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  dark:border-gray-700 `}>
            <li>
            <Link to={'/'} className={`block py-2 px-4 rounded hover:bg-gray-100 dark:hover:bg-gray-600 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 dark:text-gray-200 md:dark:hover:text-blue-500`}>
                Home
                </Link>
            </li>
            <li className="relative" style={{ margin: 'auto' }}>
              ...
              <div
                id="dropdownNavbar"
                className={`${isDropdownOpen ? 'block' : 'hidden'} absolute z-20 font-normal bg-gray-800 divide-y divide-gray-600 rounded shadow w-44 dark:bg-gray-700`}
                style={{ top: '100%', left: 0 }}
              >
                <ul className="text-sm text-gray-400" aria-labelledby="dropdownNavbarLink">
                  <li>
                  <Link to={'/create-proposal'} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Create new Proposal</Link>
                  </li>
                  <li>
                  <Link to={'/open-proposals'} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Vote on open Proposal</Link>
                  </li>
                  <li>
