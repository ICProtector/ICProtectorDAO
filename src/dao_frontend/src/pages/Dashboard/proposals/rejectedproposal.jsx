...
const RejectedProposal = () => {
    ...
    const filteredProposals = proposals.filter(proposal => proposal.status === 'Disapproved')
                                    ...
                                    <tr key={proposal.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td className="px-2 py-4">
                                            <button
                                                onClick={() => Approved()}
                                                type="button"
                                                className={`text-white font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none focus:ring-4 ${proposal.status === 'Disapproved' ? 'bg-green-500 hover:bg-green-600 border-green-600 focus:ring-green-300' : 'bg-white border-gray-300 hover:bg-gray-100 focus:ring-gray-100 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 dark:text-white'
                                                    }`}
                                            >
                                                Approve
                                            </button>
